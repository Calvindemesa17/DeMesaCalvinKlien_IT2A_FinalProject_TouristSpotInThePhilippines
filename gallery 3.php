<?php
$img = "assets/img/cave1.jpg";
$img = "assets/img/cave2.jpg";
$img = "assets/img/cave3.jpg";
$img = "assets/img/cave4.jpg";
$img = "assets/img/cave5.jpg";
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-9" data-aos="fade-up">
            <h3 class="category-title"><?php echo "Beautiful Caves In The Philippines"?></h3>

            <div class="d-md-flex post-entry-2 half">
              <a href="single-post.php" class="me-4 thumbnail">
                <img src=<?php echo"assets/img/cave1.jpg"?> alt="" class="img-fluid">
              </a>
              <div>
                <h3><a href="single-post.php"><?php echo "Tabon Cave"?></a></h3>
                <p><?php echo "The main cave, the Tabon Cave, is the site where possibly the oldest Homo sapiens fossil evidence in Southeast Asia in the form of a tibia fragment (dating to 47,000 +/- 11-10,000 years ago) has been found."?></p>
            ...
            <div class="d-md-flex post-entry-2 half">
              <a href="single-post.php" class="me-4 thumbnail">
                <img src=<?php echo"assets/img/cave2.jpg"?> alt="" class="img-fluid">
              </a>
              <div>
                <h3><a href="single-post.php"><?php echo "Callao Cave, North Luzon"?></a></h3>
                <p><?php echo "The most accessible part of the area's immense 25km limestone cave complex is the seven-chambered Callao Cave. The cave is reached by 184 slippery steps. Several sinkholes illuminate the cavernous chambers, the largest of which houses a little chapel."?></p>
                <div class="d-flex align-items-center author">   
                  <div class="name">                   
                  </div>
                </div>
            ...
            <div class="d-md-flex post-entry-2 half">
              <a href="single-post.php" class="me-4 thumbnail">
                <img src=<?php echo"assets/img/cave3.jpg"?> alt="" class="img-fluid">
              </a>
              <div>
                <h3><a href="single-post.php"><?php echo "Bukilat Cave, Camotes Island, Cebu"?></a></h3>
                <p><?php echo "But, Bukilat Cave is the most prominent among these caves. The cave has seven openings with the middle one big enough to allow light to enter the cave. The most prominent feature of the cave is the crystal clear pool inside. Some people believe the source of the water in the pool s a natural spring inside the cave."?></p>
                <div class="d-flex align-items-center author">
            ...
            <div class="d-md-flex post-entry-2 half">
              <a href="single-post.php" class="me-4 thumbnail">
                <img src="assets/img/cave4.jpg" alt="" class="img-fluid">
              </a>
              <div>
                <h3><a href="single-post.php"><?php echo "Lumiang Cave, Sagada Province"?></a></h3>
                <p><?php echo "Lumiang cave is connected to Sumaguing. There is a boundary between the two caves which your tour guide will tell you. Sumaguing is bigger and longer than Lumiang. It is very dark inside Sumaguing cave, but there are more rock formations to see here."?></p>
                <div class="d-flex align-items-center author">
            ...
            <div class="d-md-flex post-entry-2 half">
              <a href="single-post.php" class="me-4 thumbnail">
                <img src=<?php echo"assets/img/cave5.jpg"?> alt="" class="img-fluid">
              </a>
              <div>
                <h3><a href="single-post.php"><?php echo "Spelunking at Sumaguing Cave, Sagada, Mountain Province"?></a></h3>
                <p><?php echo "The Igorot tribe of Mountain Province believes that by moving the bodies of their dead higher up brings them closer to their ancestral spirit, thus the practice of Hanging Coffins. The Echo Valley …"?></p>
                <div class="d-flex align-items-center author">
              ...
              <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade show active" id="pills-popular" role="tabpanel" aria-labelledby="pills-popular-tab">
                  <div class="post-entry-1 border-bottom">
                    <h2 class="mb-2"><a href="#"><?php echo "Tabon Cave"?></a></h2>
                  </div>

                  <div class="post-entry-1 border-bottom">
                    <h2 class="mb-2"><a href="#"><?php echo "Callao Cave"?></a></h2>
                  </div>

                  <div class="post-entry-1 border-bottom">
                    <h2 class="mb-2"><a href="#"><?php echo "Bukilat Cave"?></a></h2>
                  </div>

                  <div class="post-entry-1 border-bottom">
                    <h2 class="mb-2"><a href="#"><?php echo "Lumiang Cave"?></a></h2>
                  </div>

                  <div class="post-entry-1 border-bottom">
                    <h2 class="mb-2"><a href="#"><?php echo "Spelunking at Sumaguing Cave"?></a></h2>
                  </div>
