  ...
  <main id="main">
    ...
    <section id="search-result" class="search-result">
      <div class="container">
        <div class="row">
          <div class="col-md-9">
            <h3 class="category-title"><?php echo "Search Results"?></h3>
            ...
            <div class="d-md-flex post-entry-2 small-img">
              ...
              <div>
                <div class="post-meta"><span class="date"><?php echo "Business"?></span> <span class="mx-1">&bullet;</span> <span><?php echo "Jul 5th '22"?></span></div>
                <h3><a href="single-post.php"><?php echo "What is the son of Football Coach John Gruden, Deuce Gruden doing Now?"?></a></h3>
                <p><?php echo "Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio placeat exercitationem magni voluptates dolore. Tenetur fugiat voluptates quas."?></p>
                <div class="d-flex align-items-center author">
                  <div class="photo"><img src="assets/img/person-2.jpg" alt="" class="img-fluid"></div>
                  <div class="name">
                    <h3 class="m-0 p-0"><?php echo "Wade Warren"?></h3>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="d-md-flex post-entry-2 small-img">
              ...
              <div>
                <div class="post-meta"><span class="date"><?php echo "Business"?></span> <span class="mx-1">&bullet;</span> <span><?php echo "Jul 5th '22"?></span></div>
                <h3><a href="single-post.php"><?php echo "17 Pictures of Medium Length Hair in Layers That Will Inspire Your New Haircut"?></a></h3>
                <p><?php echo "Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio placeat exercitationem magni voluptates dolore. Tenetur fugiat voluptates quas."?></p>
                <div class="d-flex align-items-center author">
                  <div class="photo"><img src="assets/img/person-2.jpg" alt="" class="img-fluid"></div>
                  <div class="name">
            ...
            <div class="d-md-flex post-entry-2 small-img">
              ...
              <div>
                <div class="post-meta"><span class="date"><?php echo "Business"?></span> <span class="mx-1">&bullet;</span> <span><?php echo "Jul 5th '22"?></span></div>
                <h3><a href="single-post.php"><?php echo "The Best Homemade Masks for Face (keep the Pimples Away)"?></a></h3>
                <p><?php echo "Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio placeat exercitationem magni voluptates dolore. Tenetur fugiat voluptates quas."?></p>
                <div class="d-flex align-items-center author">
                  <div class="photo"><img src="assets/img/person-2.jpg" alt="" class="img-fluid"></div>
                  <div class="name">
            ...
            <div class="d-md-flex post-entry-2 small-img">
              ...
              <div>
                <div class="post-meta"><span class="date"><?php echo "Business"?></span> <span class="mx-1">&bullet;</span> <span><?php echo "Jul 5th '22"?></span></div>
                <h3><a href="single-post.php"><?php echo "10 Life-Changing Hacks Every Working Mom Should Know"?></a></h3>
                <p><?php echo "Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio placeat exercitationem magni voluptates dolore. Tenetur fugiat voluptates quas."?></p>
                <div class="d-flex align-items-center author">
                  <div class="photo"><img src="assets/img/person-2.jpg" alt="" class="img-fluid"></div>
                  <div class="name">
            ...
            <div class="d-md-flex post-entry-2 small-img">
              ...
              <div>
                <div class="post-meta"><span class="date"><?php echo "Business"?></span> <span class="mx-1">&bullet;</span> <span><?php echo "Jul 5th '22"?></span></div>
                <h3><a href="single-post.php"><?php echo "9 Half-up/half-down Hairstyles for Long and Medium Hair"?></a></h3>
                <p><?php echo "Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio placeat exercitationem magni voluptates dolore. Tenetur fugiat voluptates quas."?></p>
                <div class="d-flex align-items-center author">
                  <div class="photo"><img src="assets/img/person-2.jpg" alt="" class="img-fluid"></div>
                  <div class="name">
          ...
          <div class="col-md-3">
              ...
              <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade show active" id="pills-popular" role="tabpanel" aria-labelledby="pills-popular-tab">
                  <div class="post-entry-1 border-bottom">
                    <div class="post-meta"><span class="date"><?php echo "Sport"?></span> <span class="mx-1">&bullet;</span> <span><?php echo "Jul 5th '22"?></span></div>
                    <h2 class="mb-2"><a href="#"><?php echo "How to Avoid Distraction and Stay Focused During Video Calls?"?></a></h2>
                    <span class="author mb-3 d-block"><?php echo "Jenny Wilson"?></span>
                  </div>

                  <div class="post-entry-1 border-bottom">
                    <div class="post-meta"><span class="date"><?php echo "Lifestyle"?></span> <span class="mx-1">&bullet;</span> <span><?php echo "Jul 5th '22"?></span></div>
                    <h2 class="mb-2"><a href="#"><?php echo "17 Pictures of Medium Length Hair in Layers That Will Inspire Your New Haircut"?></a></h2>
                    <span class="author mb-3 d-block"><?php echo "Jenny Wilson"?></span>
                  </div>

                  <div class="post-entry-1 border-bottom">
                    <div class="post-meta"><span class="date"><?php echo "Culture"?></span> <span class="mx-1">&bullet;</span> <span><?php echo "Jul 5th '22"?></span></div>
                    <h2 class="mb-2"><a href="#"><?php echo "9 Half-up/half-down Hairstyles for Long and Medium Hair"?></a></h2>
                    <span class="author mb-3 d-block"><?php echo "Jenny Wilson"?></span>
                  </div>

                  <div class="post-entry-1 border-bottom">
                    <div class="post-meta"><span class="date"><?php echo "Lifestyle"?></span> <span class="mx-1">&bullet;</span> <span><?php echo "Jul 5th '22"?></span></div>
                    <h2 class="mb-2"><a href="#"><?php echo "Life Insurance And Pregnancy: A Working Mom’s Guide"?></a></h2>
                    <span class="author mb-3 d-block"><?php echo "Jenny Wilson"?></span>
                  </div>

                  <div class="post-entry-1 border-bottom">
                    <div class="post-meta"><span class="date"><?php echo "Business"?></span> <span class="mx-1">&bullet;</span> <span><?php echo "Jul 5th '22"?></span></div>
                    <h2 class="mb-2"><a href="#"><?php echo "The Best Homemade Masks for Face (keep the Pimples Away)"?></a></h2>
                    <span class="author mb-3 d-block"><?php echo "Jenny Wilson"?></span>
                  </div>

                  <div class="post-entry-1 border-bottom">
                    <div class="post-meta"><span class="date"><?php echo "Lifestyle"?></span> <span class="mx-1">&bullet;</span> <span><?php echo "Jul 5th '22"?></span></div>
                    <h2 class="mb-2"><a href="#"><?php echo "10 Life-Changing Hacks Every Working Mom Should Know"?></a></h2>
                    <span class="author mb-3 d-block"><?php echo "Jenny Wilson"?></span>
                  </div>
                </div> <!-- End Popular -->
                ...
                <div class="tab-pane fade" id="pills-latest" role="tabpanel" aria-labelledby="pills-latest-tab">
                  ...
                  <div class="post-entry-1 border-bottom">
                    <div class="post-meta"><span class="date"><?php echo "Sport"?></span> <span class="mx-1">&bullet;</span> <span><?php echo "Jul 5th '22"?></span></div>
                    <h2 class="mb-2"><a href="#"><?php echo "How to Avoid Distraction and Stay Focused During Video Calls?"?></a></h2>
                    <span class="author mb-3 d-block"><?php echo "Jenny"?></span>
                  </div>

                  <div class="post-entry-1 border-bottom">
                    <div class="post-meta"><span class="date"><?php echo "Lifestyle</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22"?></span></div>
                    <h2 class="mb-2"><a href="#"><?php echo "17 Pictures of Medium Length Hair in Layers That Will Inspire Your New Haircut"?></a></h2>
                    <span class="author mb-3 d-block"><?php echo "Jenny Wilson"?></span>
                  </div>
            ...
            <div class="aside-block">
              <h3 class="aside-title"><?php echo "Video"?></h3>
            ...
            <div class="aside-block">
              <h3 class="aside-title"><?php echo "Categories"?></h3>
