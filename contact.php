      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-12 text-center mb-5">
            <h1 class="page-title"><?php echo "Contact us"?></h1>
          </div>
        </div>
        ...
        <div class="row gy-4">
          ...
          <div class="col-md-4">
            <div class="info-item">
              ...
              <address><?php echo "Maranlig, Torrijos, Marinduque, Philippine"?></address>
            </div>
          </div><!-- End Info Item -->
          ...
          <div class="col-md-4">
            <div class="info-item info-item-borders">
              ...
              <h3><?php echo "Phone Number"?></h3>
              <p><a href="tel:+155895548855"><?php echo "+63 9238 17389 32"?></a></p>
            </div>
          </div><!-- End Info Item -->
          ...
          <div class="col-md-4">
            <div class="info-item">
              ...
              <p><a href="mailto:info@example.com"><?php echo "calvinkliend@gmail.com"?></a></p>
            </div>
          </div><!-- End Info Item -->
