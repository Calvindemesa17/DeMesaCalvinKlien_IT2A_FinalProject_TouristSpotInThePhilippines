<?php
$img = "assets/img/volcano2.jpg";
$img = "assets/img/volcano3.jpg";
$img = "assets/img/volcano4.jpg";
$img = "assets/img/volcano5.jpg";
$img = "assets/img/volcano6.jpg";
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-9" data-aos="fade-up">
            <h3 class="category-title"><?php echo "Beautiful Volcano In The Philippines"?></h3>

            <div class="d-md-flex post-entry-2 half">
              <a href="single-post.php" class="me-4 thumbnail">
                <img src=<?php echo"assets/img/volcano2.jpg"?> alt="" class="img-fluid">
              </a>
              <div>
                <h3><a href="single-post.php"><?php echo "Mayon Volcano"?></a></h3>
            ...
            <div class="d-md-flex post-entry-2 half">
              <a href="single-post.php" class="me-4 thumbnail">
                <img src=<?php echo"assets/img/volcano4.jpg"?> alt="" class="img-fluid">
              </a>
              <div>
                <h3><a href="single-post.php"><?php echo "Mount Bulusan"?></a></h3>
                <p><?php echo "Mount Bulusan, also known as Bulusan Volcano, is a stratovolcano on the island of Luzon in the Philippines. Located in the province of Sorsogon in the Bicol Region, it is 70 kilometres southeast of Mayon Volcano and approximately 390 kilometres southeast of the Philippine capital of Manila."?></p>
                <div class="d-flex align-items-center author">
            ...
            <div class="d-md-flex post-entry-2 half">
              <a href="single-post.php" class="me-4 thumbnail">
                <img src="assets/img/volcano5.jpg" alt="" class="img-fluid">
              </a>
              <div>
                <h3><a href="single-post.php"><?php echo "Mount Malindig"?></a></h3>
                <p><?php echo "Mount Malindig is a large potentially active stratovolcano on the island of Marinduque in the Philippines. It is the highest peak in the island having an elevation of 1,157 metres above sea level. The name Marinduque itself may have been derived from Marindik or Malindik."?></p>
                <div class="d-flex align-items-center author">
            ...
            <div class="d-md-flex post-entry-2 half">
              <a href="single-post.php" class="me-4 thumbnail">
                <img src=<?php echo"assets/img/volcano6.jpg"?> alt="" class="img-fluid">
              </a>
              <div>
                <h3><a href="single-post.php"><?php echo "Mount Apo"?></a></h3>
                <p><?php echo "Mount Apo, also known locally as Apo Sandawa, is a large solfataric, dormant stratovolcano on the island of Mindanao, Philippines. With an elevation of 2,954 meters above sea level, it is the highest-mountain in the Philippine Archipelago, Mindanao and 24th-highest peak of an island on Earth."?></p>
                <div class="d-flex align-items-center author">
            ...
            <div class="aside-block">
              ...
              <ul class="nav nav-pills custom-tab-nav mb-4" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
                  <button class="nav-link active" id="pills-popular-tab" data-bs-toggle="pill" data-bs-target="#pills-popular" type="button" role="tab" aria-controls="pills-popular" aria-selected="true"><?php echo "Top 5 Volcano in The Philippines"?></button>
                </li>
                <li class="nav-item" role="presentation">
              ...
              <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade show active" id="pills-popular" role="tabpanel" aria-labelledby="pills-popular-tab">
                  ...
                  <div class="post-entry-1 border-bottom">
                    <h2 class="mb-2"><a href="#"><?php echo "Taal Volcano"?></a></h2>
                  </div>

                  <div class="post-entry-1 border-bottom">
                    <h2 class="mb-2"><a href="#"><?php echo "Mount Bulusan"?></a></h2>
                  </div>

                  <div class="post-entry-1 border-bottom">
                    <h2 class="mb-2"><a href="#"><?php echo "Mount Malindig"?></a></h2>
                  </div>

                  <div class="post-entry-1 border-bottom">
                    <h2 class="mb-2"><a href="#"><?php echo "Mount Apo"?></a></h2>
                  </div>
