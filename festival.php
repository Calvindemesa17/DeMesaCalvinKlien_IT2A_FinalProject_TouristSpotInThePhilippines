<?php
$img = "assets/img/festival1.jpg";
$img = "assets/img/festival2.jpg";
$img = "assets/img/festival3.jpg";
$img = "assets/img/festival4.jpg";
$img = "assets/img/festival5.jpg";
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-9" data-aos="fade-up">
            <h3 class="category-title"><?php echo "Festival in Philippines"?></h3>

            <div class="d-md-flex post-entry-2 half">
              <a href="single-post.php" class="me-4 thumbnail">
                <img src=<?php echo"assets/img/festival1.jpg"?> alt="" class="img-fluid">
              </a>
              <div>
                <h3><a href="single-post.php"><?php echo "Panagbenga Festival"?></a></h3>
                <p><?php echo "Panagbenga Festival is a month-long annual flower occasion in Baguio, Philippines. The term is of Kankanaey origin, meaning season of blooming. The festival, held in February, was created as a tribute to the city's flowers and as a way to rise from the devastation of the 1990 Luzon earthquake. "?></p>
            ...
            <div class="d-md-flex post-entry-2 half">
              <a href="single-post.php" class="me-4 thumbnail">
                <img src=<?php echo"assets/img/festival2.jpg"?> alt="" class="img-fluid">
              </a>
              <div>
                <h3><a href="single-post.php"><?php echo "Dinagyang Festival"?></a></h3>
                <p><?php echo "The Dinagyang Festival is a religious and cultural festival in Iloilo City, Philippines, held annually on the 4th Sunday of January, or right after the Sinulog in Cebu and the Ati-Atihan Festival in Kalibo, Aklan"?></p>
                <div class="d-flex align-items-center author">   
                  <div class="name">                   
                  </div>
                </div>
            ...
            <div class="d-md-flex post-entry-2 half">
              <a href="single-post.php" class="me-4 thumbnail">
                <img src=<?php echo"assets/img/festival3.jpg"?> alt="" class="img-fluid">
              </a>
              <div>
                <h3><a href="single-post.php"><?php echo "Moriones Festival"?></a></h3>
                <p><?php echo "The Moriones is a lenten festival held annually on Holy Week on the island of Marinduque, Philippines. The Moriones are men and women in costumes and masks replicating the garb of biblical Imperial Roman soldiers as interpreted by locals"?></p>
                <div class="d-flex align-items-center author">
            ...
            <div class="d-md-flex post-entry-2 half">
              <a href="single-post.php" class="me-4 thumbnail">
                <img src="assets/img/festival4.jpg" alt="" class="img-fluid">
              </a>
              <div>
                <h3><a href="single-post.php"><?php echo "Ati-Atihan Festival"?></a></h3>
                <p><?php echo "The Kalibo Santo Niño—Ati-Atihan Festival, also simply called Ati-Atihan Festival, is a Philippine festival held annually in January in honor of the Santo Niño (Holy Child or Infant Jesus) in several towns of the province of Aklan, Panay Island."?></p>
                <div class="d-flex align-items-center author">
            ...
            <div class="d-md-flex post-entry-2 half">
              <a href="single-post.php" class="me-4 thumbnail">
                <img src=<?php echo"assets/img/festival5.jpg"?> alt="" class="img-fluid">
              </a>
              <div>
                <h3><a href="single-post.php"><?php echo "Masskara Festival"?></a></h3>
                <p><?php echo "The MassKara Festival is an annual festival with highlights held every 4th Sunday of October in Bacolod, Philippines. The most recent festival was held last October 30, 2021. The festival sites include the Bacolod Public Plaza, the Lacson Tourism Strip and the Bacolod City Government Center."?></p>
                <div class="d-flex align-items-center author">
            ...
            <div class="aside-block">
              ...
              <ul class="nav nav-pills custom-tab-nav mb-4" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
                  <button class="nav-link active" id="pills-popular-tab" data-bs-toggle="pill" data-bs-target="#pills-popular" type="button" role="tab" aria-controls="pills-popular" aria-selected="true"><?php echo "Top 5 Festival in The Philippines"?></button>
                </li>
                <li class="nav-item" role="presentation">
              ...
              <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade show active" id="pills-popular" role="tabpanel" aria-labelledby="pills-popular-tab">
                  <div class="post-entry-1 border-bottom">
                    <h2 class="mb-2"><a href="#"><?php echo "Panagbenga Festival"?></a></h2>
                  </div>

                  <div class="post-entry-1 border-bottom">
                    <h2 class="mb-2"><a href="#"><?php echo "Dinagyang Festival"?></a></h2>
                  </div>

                  <div class="post-entry-1 border-bottom">
                    <h2 class="mb-2"><a href="#"><?php echo "Moriones Festival"?></a></h2>
                  </div>

                  <div class="post-entry-1 border-bottom">
                    <h2 class="mb-2"><a href="#"><?php echo "Ati-Atihan Festival"?></a></h2>
                  </div>

                  <div class="post-entry-1 border-bottom">
                    <h2 class="mb-2"><a href="#"><?php echo "Masskara Festival"?></a></h2>
                  </div>
