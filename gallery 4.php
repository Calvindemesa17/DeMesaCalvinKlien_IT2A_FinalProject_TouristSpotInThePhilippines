<?php
$img = "assets/img/falls1.jpg";
$img = "assets/img/falls2.jpg";
$img = "assets/img/falls3.jpg";
$img = "assets/img/falls4.jpg";
$img = "assets/img/falls5.jpg";
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-9" data-aos="fade-up">
            <h3 class="category-title"><?php echo "Beautiful Falls In The Philippines"?></h3>

            <div class="d-md-flex post-entry-2 half">
              <a href="single-post.php" class="me-4 thumbnail">
                <img src=<?php echo"assets/img/falls1.jpg"?> alt="" class="img-fluid">
              </a>
              <div>
                <h3><a href="single-post.php"><?php echo "Asik-asik Falls, Alamada, North Cotabato"?></a></h3>
                <p><?php echo "Asik-Asik literally means “sprinkle-sprinkle” in the native Hiligaynon language. It is aptly called since it sprinkles cold water as it drops into the shallow rocky pool at the base of the mountain. The water collected in the pool then flows to join a tributary of the Alamada River."?></p>
            ...
            <div class="d-md-flex post-entry-2 half">
              <a href="single-post.php" class="me-4 thumbnail">
                <img src=<?php echo"assets/img/falls2.jpg"?> alt="" class="img-fluid">
              </a>
              <div>
                <h3><a href="single-post.php"><?php echo "Kawasan Falls, Cebu"?></a></h3>
                <p><?php echo "Kawasan Falls actually consists of three separate layers of waterfalls with the first layer being the biggest and by far the most crowded, especially during weekends. Most people who walk off the highway to the waterfalls hang out here, where there are cottages for rent to locals and tourists."?></p>
                <div class="d-flex align-items-center author">   
                  <div class="name">                   
                  </div>
                </div>
            ...
            <div class="d-md-flex post-entry-2 half">
              <a href="single-post.php" class="me-4 thumbnail">
                <img src=<?php echo"assets/img/falls3.jpg"?> alt="" class="img-fluid">
              </a>
              <div>
                <h3><a href="single-post.php"><?php echo "Tinuy-an Falls, Surigao del Sur"?></a></h3>
                <p><?php echo "Located on the island of Mindanao in the Philippines, Tinuy-an Falls is a multi-tiered waterfall said to be the widest in the country. The falls measure 95 meters (312 feet) wide and 55 meters (180 feet) tall. Tinuy-an Falls cascades over three tiers, with the second being the largest and most impressive."?></p>
                <div class="d-flex align-items-center author">
            ...
            <div class="d-md-flex post-entry-2 half">
              <a href="single-post.php" class="me-4 thumbnail">
                <img src="assets/img/falls4.jpg" alt="" class="img-fluid">
              </a>
              <div>
                <h3><a href="single-post.php"><?php echo "Tinago Falls, Iligan City"?></a></h3>
                <p><?php echo "Approximately 240 feet high, its colossal rock structures are dotted by thick masses of trees and natural foliage. Despite this towering scene, what lies at the bottom of the falls leaves visitors in even greater awe. Tinago's basin features a stunning blue-green pool of water."?></p>
                <div class="d-flex align-items-center author">
            ...
            <div class="d-md-flex post-entry-2 half">
              <a href="single-post.php" class="me-4 thumbnail">
                <img src=<?php echo"assets/img/falls5.jpg"?> alt="" class="img-fluid">
              </a>
              <div>
                <h3><a href="single-post.php"><?php echo "Merloquet Falls, Zamboanga"?></a></h3>
                <p><?php echo "Merloquet Falls is actually a two tiered waterfalls with the upper level located around 50 meters from the main cascade. This upper tier is stunning, with an inclined rock face with five separate but low cascades. The water stream into a shallow basin then flows downstream into the main waterfall in a wide curtain."?></p>
                <div class="d-flex align-items-center author">
            ...
            <div class="aside-block">
              ...
              <ul class="nav nav-pills custom-tab-nav mb-4" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
                  <button class="nav-link active" id="pills-popular-tab" data-bs-toggle="pill" data-bs-target="#pills-popular" type="button" role="tab" aria-controls="pills-popular" aria-selected="true"><?php echo "Top 5 Caves in The Philippines"?></button>
                </li>
                <li class="nav-item" role="presentation">
              ...
              <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade show active" id="pills-popular" role="tabpanel" aria-labelledby="pills-popular-tab">
                  <div class="post-entry-1 border-bottom">
                    <h2 class="mb-2"><a href="#"><?php echo "Asik-asik Falls, Alamada, North Cotabato"?></a></h2>
                  </div>

                  <div class="post-entry-1 border-bottom">
                    <h2 class="mb-2"><a href="#"><?php echo "Kawasan Falls, Cebu"?></a></h2>
                  </div>

                  <div class="post-entry-1 border-bottom">
                    <h2 class="mb-2"><a href="#"><?php echo "Tinuy-an Falls, Surigao del Sur"?></a></h2>
                  </div>

                  <div class="post-entry-1 border-bottom">
                    <h2 class="mb-2"><a href="#"><?php echo "Tinago Falls, Iligan City"?></a></h2>
                  </div>

                  <div class="post-entry-1 border-bottom">
                    <h2 class="mb-2"><a href="#"><?php echo "Merloquet Falls, Zamboanga"?></a></h2>
                  </div>
